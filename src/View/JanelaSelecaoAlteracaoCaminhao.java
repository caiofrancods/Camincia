...
public class JanelaSelecaoAlteracaoCaminhao extends JanelaListagemCaminhao{
	private Caminhao caminhao;

	private JButton btSelecao;

	public JanelaSelecaoAlteracaoCaminhao(List<Caminhao> caminhoes) {
		super(caminhoes); // chama o construtor da superclasse JanelaListagemAluno
	...
	protected void initGUI() {
		...
		setTitle("Selecione um caminhão para alterar");
		btSelecao.setText("Alterar");
	...
	private class ExcluirListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			caminhao = model.getCaminhao(linhaSelecionada);
			dispose();
		}
