...
public class JanelaDemitirFuncionario extends JanelaListagemFuncionario{
	private Funcionario funcionario;

	private JButton btSelecao;

	public JanelaDemitirFuncionario(List<Funcionario> funcionarios) {
	...
	protected void initGUI() {
		...
		setTitle("Selecione um funcionário para demitir");
		btSelecao.setText("Demitir");
