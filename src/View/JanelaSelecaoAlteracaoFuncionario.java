...
public class JanelaSelecaoAlteracaoFuncionario extends JanelaListagemFuncionario{
	private Funcionario funcionario;

	private JButton btSelecao;

	public JanelaSelecaoAlteracaoFuncionario(List<Funcionario> funcionarios) {
	...
	protected void initGUI() {
		...
		setTitle("Selecione um funcionário para alterar");
