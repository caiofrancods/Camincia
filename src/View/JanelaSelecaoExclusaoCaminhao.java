...
public class JanelaSelecaoExclusaoCaminhao extends JanelaListagemCaminhao{
	private Caminhao caminhao;

	private JButton btSelecao;

	public JanelaSelecaoExclusaoCaminhao(List<Caminhao> caminhoes) {
	...
	protected void initGUI() {
		...
		setTitle("Selecione um caminhão para excluir");
